...
4. Does the output include a "What We Don't Know" section? Report actual unanswered questions and source-access limitations. If the record fully answers the question, state that without inventing gaps.
