...
- **Source history**: change records with messages like "fix for incident", "add defensive check", "revert" followed by "re-apply with..." are strong signals
