...
For a delegated search, give each investigator the playbook for its assigned evidence category. The parent selects categories proportionately to the question, as described in SKILL.md. The playbooks are concrete examples for common MCPs; adapt them for a different MCP in the same category.

| Category | Playbook | Example MCP it documents |
|---|---|---|
| Source control history | [`code-archaeology.md`](./sources/code-archaeology.md) | Project VCS and review-host tools |
