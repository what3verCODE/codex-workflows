...
**Relevant revisions, change records or snapshots touching this code:**
{CHANGE_HISTORY}

**Linked review identifiers or URLs, if available:** {REVIEW_REFERENCES}

**Ticket IDs mentioned in change records or reviews, if any:** {TICKET_IDS}
