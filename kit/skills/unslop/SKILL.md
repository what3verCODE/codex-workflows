---
name: unslop
description: Remove AI writing patterns when drafting or editing documentation and memory-bank files. Do not apply to conversational answers, status updates, scout findings, or routine agent reports.
---
