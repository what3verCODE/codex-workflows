...
Read `../workflow-context/SKILL.md` and resolve task evidence, project instructions, existing edits, branch and original baselines before changing behavior.
